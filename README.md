...
### Screenshot
***
![Screenshot](AppMqttScreenCapture/Menu.png){:height="50%" width="50%"}
![Screenshot](AppMqttScreenCapture/Relay.png){:height="50%" width="50%"}
![Screenshot](AppMqttScreenCapture/AddDevice.png){:height="50%" width="50%"}
